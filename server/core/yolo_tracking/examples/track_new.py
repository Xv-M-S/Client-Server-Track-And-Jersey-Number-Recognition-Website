...
sys.path.append(os.path.join(current_folder_path,".."))
...
from examples.utils_new import write_mot_results, video_mot_results
import logging
# 是否开启DEBUG模式
...
def run(args):
    ...
    for frame_idx, r in enumerate(results):
        ...
        if args.save_video:
            # 构建完整的保存路径
            video_writer = video_mot_results(frame_idx, r, save_video_path, video_writer)
...
def parse_opt():
    ...
    parser.add_argument('--project', default='/home/sxm/YoloTracking/yolo_tracking/results/runs/track',
